...
_deepseek_ai_schemastery.default.object({
	showJobs: _deepseek_ai_schemastery.default.boolean().default(DEFAULTS.showJobs),
	showWaits: _deepseek_ai_schemastery.default.boolean().default(DEFAULTS.showWaits),
	showSubagents: _deepseek_ai_schemastery.default.boolean().default(DEFAULTS.showSubagents),
	autoFollowOutput: _deepseek_ai_schemastery.default.boolean().default(DEFAULTS.autoFollowOutput)
});
//#endregion
